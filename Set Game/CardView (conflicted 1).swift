...
class CardView: UIView {
    ...
    enum CardViewState {
        case inDeck, onTable, out
    }
    
    var state: CardViewState = .inDeck
    var destination: CardViewState = .onTable
    ...
    func animate(to newFrame: CGRect, delay: TimeInterval = 0) {
        ...
        UIView.transition(from: <#T##UIView#>, to: <#T##UIView#>, duration: <#T##TimeInterval#>, options: <#T##UIViewAnimationOptions#>, completion: <#T##((Bool) -> Void)?##((Bool) -> Void)?##(Bool) -> Void#>)
